...
public class ViewFactory {
    ...
    /**
     * A view of the name part at it's most recent approved and pending revisions.
     *
    ...
    /**
     * A view of the name part at the given revision.
     *
    ...
    /**
     * A view of the name part based on explicitly given approved and pending revisions. The view of the parent name
     * part can optionally be provided when available, so the data does not need to be queried from the database later.
     *
     ...
     * @param parentView optional view of the parent, so that the data does not need to be fetched from the database.
    ...
    /**
     * A view of the device based at the given revision.
     *
    ...
    /**
     * A view of the device based at the given revision. The views of the device's section and device type can
     * optionally be provided when available, so the data does not need to be queried from the database later.
     *
     * @param deviceRevision the device revision
     * @param sectionView optional view of the device's section, so that the data does not need to be fetched from the
     * database. Null if none is provided.
     * @param deviceTypeView optional view of the device's device type, so that the data does not need to be fetched
     * from the database. Null if none is provided.
     */
